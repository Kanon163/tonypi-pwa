...
- `robot-bridge`：执行 `tasks/0019-wave4-tonypi-bridge-probe.md`，Issue `#12`
- `bci-cloud`：执行 `tasks/0020-wave4-bci-web-bluetooth-probe.md`，Issue `#13`
- `app-pwa`：等待 `0019`、`0020` 初版 `HANDOFF.md` 后执行 `tasks/0021-wave4-pwa-live-adapter-seam.md`，Issue `#14`
- `integration-review`：最后执行 `tasks/0022-wave4-integration-gate.md`，Issue `#15`
